...
from Draw_Box.background_image_layer_view import BackgroundImageLayerView, BackgroundImageLayerView_2
...
class MapCanvas(QWidget):
    def __init__(self, tile_selector: 'TileSelector', tile_data_view, model: MainDataModel = None):
        ...
        self.background_image_layer_2 = BackgroundImageLayerView_2(model=self.model, parent=self)
        self.grid_layer = GridLayer(self.model, parent=self)
        
        
        self.background_image_layer.move(0,0)
        self.background_image_layer.lower()
        self.background_image_layer_2.move(0,0)
        self.background_image_layer_2.raise_()
        ...
        self.layer_views = {
            ...
            "background_2": self.background_image_layer_2,            
